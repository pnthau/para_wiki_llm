...
| **Cú pháp Flexbox Menu tiêu chuẩn** | ```css<br>nav ul {<br>  list-style: none; /* Reset: Xóa markers mặc định */<br>  margin: 0;<br>  padding: 0;<br>  display: flex; /* Bật Flexbox */<br>  gap: 1.5rem; /* Khoảng cách giữa các item */<br>  align-items: center; /* Căn giữa theo chiều dọc */<br>}<br>nav ul li a {<br>  display: block;<br>  padding: 8px 16px;<br>  text-decoration: none;<br>  transition: background 0.2s;<br>}<br>```                                                                                    |
