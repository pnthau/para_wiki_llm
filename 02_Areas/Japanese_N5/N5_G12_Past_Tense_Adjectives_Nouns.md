...
| :--- | :--- |
| **Tính từ đuôi い** | Khẳng định: Bỏ `～い` + `～かったです` <br>Phủ định: Bỏ `～い` + `～くなかったです` <br>Ví dụ: 寒かったです (Đã lạnh). |
| **Tính từ đuôi な** | Khẳng định: + `～でした` <br>Phủ định: + `～じゃありませんでした` <br>Ví dụ: 静かでした (Đã yên tĩnh). |
| **Danh từ** | Khẳng định: + `～でした` <br>Phủ định: + `～じゃありませんでした` <br>Ví dụ: 雨でした (Đã mưa). |
