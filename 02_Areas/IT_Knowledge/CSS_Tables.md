...
| :---------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Đường viền & Lỗi viền đôi**      | - Mặc định, viết `table, th, td { border: 1px solid black; }` sẽ tạo ra **viền đôi** do mỗi cell và table đều vẽ viền độc lập.<br>- Sử dụng **`border-collapse: collapse;`** trên thẻ `<table>` để gộp các đường viền chồng chéo lại thành một đường viền đơn duy nhất.<br>```css<br>table {<br>  border-collapse: collapse;<br>}<br>```                                                                                                                                                        |
