...
| :--- | :--- |
| **So sánh hơn** | `A は B より [Tính từ] です` <br>Ý nghĩa: A hơn B. <br>Ví dụ: 冬は夏より寒いです。 |
| **So sánh lựa chọn** | `A と B と どちらが [Tính từ] ですか` <br>Ý nghĩa: Giữa A và B cái nào [Tính từ] hơn? <br>Trả lời: `A (のほう) が [Tính từ] です。` |
| **So sánh nhất** | `[Phạm vi] の中で [Cái gì] が いchiban [Tính từ] ですか` <br>Ý nghĩa: Trong [Phạm vi], [Cái gì] là nhất? <br>Ví dụ: スポーツの中で何がいちばん面白いですか。 |
